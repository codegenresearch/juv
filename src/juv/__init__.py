...
@click.option("--dependencies", "-d", multiple=True, help="Add package dependencies during initialization.")
def init(
    file: str | None,
    python: str | None,
    dependencies: tuple[str, ...],
) -> None:
    """Initialize a new notebook with optional dependencies."""
    from ._init import init

    init(path=Path(file) if file else None, python=python, packages=dependencies)
